...
int main(int argc, char **argv)
{
    ...
    while (1) {
        ...
        if(len == 0)
            ...
            printf("Error code is %d，Error messages are '%s'\n", errno, strerror(errno));
...
// http://blog.csdn.net/sjin_1314/article/details/21043613
// https://segmentfault.com/a/1190000002554673
// http://blog.csdn.net/u011196543/article/details/42617785